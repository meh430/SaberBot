...
public class OperationEvent extends ListenerAdapter {
    ...
    public void onGuildMessageReceived(@NotNull GuildMessageReceivedEvent discordEvent) {
        ...
        if (userMessageSentArr[0].equalsIgnoreCase("!add")) {
            ...
            for (int i = 1; i < userMessageSentArr.length; i++) strExpression.append(userMessageSentArr[i]);
        ...
        //subtract
        if (userMessageSentArr[0].equalsIgnoreCase("!subtract")) {
            StringBuilder strExpression = new StringBuilder();
        ...
        //multiply
        if (userMessageSentArr[0].equalsIgnoreCase("!multiply")) {
            StringBuilder strExpression = new StringBuilder();
        ...
        //divide
        if (userMessageSentArr[0].equalsIgnoreCase("!divide")) {
            StringBuilder strExpression = new StringBuilder();
